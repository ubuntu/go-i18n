# Contributing to go-i18n

A big welcome and thank you for considering contributing to go-i18n and Ubuntu! It’s people like you that make it a reality for users in our community.
...
* Include developer documentation in the repo formatted with the standard Go practices.
...
This project follow the Google code-style. For more informative information about the code style in use, please check [this styleguide](https://google.github.io/styleguide/go/)
